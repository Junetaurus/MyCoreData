...
{
    static MyCoreDataManager *coreDataManager;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        coreDataManager = [[MyCoreDataManager alloc] init];
    });
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "taurus.MyCoreData" in the application's documents directory.
